...
def main():
    ...
    parser = argparse.ArgumentParser(description="Vehicle Speed Estimator")
    parser.add_argument("--lookup", required=True, help="Path to calibration lookup table (.npy)")
    parser.add_argument("--video", required=True, help="Path to input video")
    parser.add_argument("--output", required=True, help="Path to output video")
    args = parser.parse_args()

    estimator = SpeedEstimator(args.lookup)
    estimator.process_video(args.video, args.output)
